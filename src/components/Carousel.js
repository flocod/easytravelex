...
import caroussel1 from "../images/caroussels/caroussel1.webp";
...
import caroussel6 from "../images/caroussels/caroussel6.webp";
import caroussel7 from "../images/caroussels/caroussel7.webp";
...
function Carousel() {
  ...
  useEffect(() => {
    ...
    let currentIndex = 0;
    let showNextImageInterval= null;
      ...
      <section className="section caroussel" >
        ...
        <div className="text_carousel">
          <div className="intro">
            ...
            <p>
              Your bus stop for Tourist Visa, Visa change, freelance Visa, flights
              & Hotel reservation.
            </p>
            ...
            <div className="contain_card_text">
              <div className="contain_card_text__struct">
                ...
                <p className="p_normal">
                  We made it more easier for you in order to provide you with the
                  best service, our system has been optimisez to make sure we give
                  you satisfactory visa service. Please select your option below
                  and proceed.
                </p>
