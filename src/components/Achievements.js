          ...
          <div className="section_container section_container_achievements">
            <div className="text_group_container">
              ...
              <div className="group_title">
                <p>
                  {" "}
                  <img className="after" src={imgBtnDesign} alt="" /> OUR
                  EXPERIENCE
                </p>
              ...
              <p className="normal_description">
                XYZ Company is a reliable and forward-thinking technology
                solutions provider that is committed to delivering exceptional
                products and services. With our vast experience, technical
                expertise, and customer-centric approach, we are well-equipped to
