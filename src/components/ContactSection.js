          ...
          <div className="section_container section_container_achievements">
            <div className="text_group_container contact_group_container">
              ...
              <div className="group_title">
                ...
                <p>Reach out to us via this channels</p>
              </div>
                    ...
                    <div className="item__struct">
                      <div className="channel">
                        ...
                        <div className="channel_text">
                          <div className="channel_text__title">WhatsApp</div>
                  ...
                  <div class="item item2">
                    <div className="item__struct">
                      <div className="channel">
                        ...
                        <div className="channel_text">
                          <div className="channel_text__title">Call now</div>
                          <div className="channel_text__value">
                            +971 50 829 1203
                          </div>
                        </div>
                  ...
                  <div class="item item3">
                    <div className="item__struct">
                      <div className="channel">
                        ...
                        <div className="channel_text">
                          <div className="channel_text__title">Telegram</div>
                          <div className="channel_text__value">
                            +971 50 829 1203
                          </div>
                        </div>
                  ...
                  <div class="item item4">
                    <div className="item__struct">
                      <div className="channel">
                        ...
                        <div className="channel_text">
                          <div className="channel_text__title">Skype</div>
                          <div className="channel_text__value">
                            easy.travelex22
                          </div>
                        </div>
