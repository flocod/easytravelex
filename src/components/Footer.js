        ...
        <div className="footer_container">
          <div className="footer_item">
            <div className="logo_footer" >
              <img onClick={handleClickLogo} src={logo} alt="logo Easy Travelex" />
            </div>

            <p className="footer_description">
              Qasimi Al waad Muweila Building 3 - Office 2003 Sharjah - United
              Arab Emirates
            </p>
          </div>
          ...
          <div className="footer_item footer_itel_margin">
            ...
            <div className="contacts">
              <a href="mailto:contact@easytravelex.ae" className="contact_item">
                <div className="ico">
                  <svg
                ...
                <div className="value"> contact@easytravelex.ae</div>
              </a>

              <a href="tel:+971506001298" className="contact_item">
                <div className="ico">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={20}
          ...
          <div className="footer_item">
            <div className="footer_item__title">Find us on Gmaps</div>
