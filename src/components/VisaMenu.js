...
const VisaMenu = () => {
  useEffect(() => {
    const handleLinkClick = (event) => {
      ...
      const links = document.querySelectorAll(".VisaMenu .menu_item");
      ...
      <div className="struct">
        <div className="menu_item active">
          <div className="content">
            ...
            <div className="text">
              <div className="t1">United Arab Emirates</div>
              <div className="t2">
                Starting from : <span className="val">450 AED</span>{" "}
              </div>
            </div>
          </div>
        </div>
        <div className="menu_item ">
          <div className="content">
            ...
            <div className="text">
              <div className="t1">Saudi Arabia</div>
              <div className="t2">
                Starting from : <span className="val">450 AED</span>{" "}
              </div>
            </div>
