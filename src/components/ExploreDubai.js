      ...
      >
        ...
        >
          <div className="struct">
            <div
              className="big_text layer_section"
              style={{
                marginTop: "0px",
                paddingTop: "30px",
              }}
            ...
            <div className="section_header">
              <div className="titre_section">
                ...
                <p className="p">
                  We strive for quality service. Find below are successfully
                  completed clients projects
                </p>
              </div>
        ...
        <section className="section_exploration">
          <div className="section_exploration__container">
            <ExploreItem
              isActive={true}
              img={caroussel2}
              title="Desert Safari tours"
              description="We strive for quality service. Find below are successfully completed clients projects"
            ></ExploreItem>
            <ExploreItem
              isActive={false}
              img={caroussel3}
              title="Explore Burj Khalifa"
              description="We have the best options and pricing. Look no further, you are at the right place"
            ></ExploreItem>
            <ExploreItem
              isActive={false}
              img={caroussel4}
