...
import imgCheckCircle from "../images/svg/checkcircle.svg";
import imgLongRightArrow from "../images/svg/long-right-arrow.svg";
...
import imgCircleRelocation from "../images/svg/circleRelocation.svg";
...
function RelocationSection() {
  function Relocation() {
    ...
    const basicContainer = (
      <div className="relocation_loader_container ">
        <div className="container_item">
          <div className="descr">
            This is a stress free package, that gives you peace of mind such if
            you decide otherwise you can easily go back home.
          </div>
          ...
          <ul className="list">
            ...
            <li>
              {" "}
              <img src={imgCheckCircle} alt="" />{" "}
              <div className="text">60 days visa (Extendable)</div>
            </li>
            <li>
              {" "}
              <img src={imgCheckCircle} alt="" />{" "}
            ...
            <li>
              {" "}
              <img src={imgCheckCircle} alt="" />{" "}
              <div className="text">Airport pick up by SUV 4x4</div>
            </li>
            <li>
              {" "}
              <img src={imgCheckCircle} alt="" />{" "}
            ...
            <li>
              {" "}
              <img src={imgCheckCircle} alt="" />{" "}
              <div className="text">One (01) full day of city tour</div>
            </li>
            <li>
              {" "}
              <img src={imgCheckCircle} alt="" />{" "}
              <div className="text">30 days shared accommodation</div>
            </li>
          </ul>

          <div className="price">
            <div className="text" after="$1,700 USD">
              $1,500 USD
            </div>
    ...
    const plusContainer = (
      <div className="relocation_loader_container">
        <div className="container_item">
          ...
          <div className="price">
            <div className="text" after="$5,750 USD">
              $5,300 USD
            </div>
    ...
    const ultraContainer = (
      <div className="relocation_loader_container">
        <div className="container_item">
          ...
          <div className="price">
            <div className="text" after="$61,700 USD">
              $542,500 USD
            </div>
    ...
    const relocation_btn_basic = useRef();
    const relocation_btn_plus = useRef();
    const relocation_btn_ultra = useRef();
      ...
      animateRelocation.from(
        ".relocation_loader_container .descr, .relocation_loader_container .list *, .relocation_loader_container .price",
        {
          ...
          onStart: function () {
            ...
            function desactiverEtReactiverBouton(btn) {
    ...
    const handleRelocationMenuClick = (event) => {
      event.preventDefault();
      // console.log("handleLinkClick this", event.currentTarget);
      const relocation_menulinks = document.querySelectorAll(
        ".relocation_menu .rectangle_btn"
      );
      relocation_menulinks.forEach((link) => link.classList.remove("active"));
    ...
    return (
      <div className="relocation_container">
          ...
          <div className="relocation_menu">
            <div
              ...
              className={`rectangle_btn ${
                relocationBundle === bundle.basic ? "active" : ""
              }`}
            >
            ...
            <div
              ...
              className={`rectangle_btn ${
                relocationBundle === bundle.ultra ? "active" : ""
              }`}
            >
        ...
        <div className="relocation_image">
          <div className="img">
            <img src={previewRelocation.basic} alt={previewRelocation.basic} />
          </div>
