...
import imgCircleBooking from "../images/svg/circlebooking.svg";
import imgRelocation1 from "../images/relocation1.webp";
import imgRelocation2 from "../images/relocation2.jpg";
import imgRelocation3 from "../images/relocation3.jpg";
import UaTown from "../components/UaTown";

const ToursApplication = () => {
  let passport_btn = useRef();
  let hidden_file_input = useRef();
  ...
  const handleChangeHiddenFileInput = (evt) => {
    evt.stopPropagation();
    let passportInputTarget = document.getElementById("passportInputTarget");
  ...
  const town_item = (town, id, handleDeleteIco) => {
    return (
  ...
  const handleChangeInputTown = (event) => {
  ...
  useEffect(() => {
    ...
    nationality.value = itiNationality.getSelectedCountryData().name;
    nationality.addEventListener("countrychange", handleCountryChange, false);
    ...
    const handleWheelGalerieCard = (e) => {
      e.preventDefault();

      const propElement = carouselContainer
        .querySelector(".card_galerie")
        .getBoundingClientRect();
      console.log(
        carouselContainer.querySelector(".card_galerie").getBoundingClientRect()
      );
    ...
    const carouselContainer = document.querySelector(".card_galerie_container");

    carouselContainer.addEventListener("wheel", handleWheelGalerieCard, false);
                ...
                <div className="card_galerie_container">
                  <div className="card_galerie">
                    <div className="card_galerie__img">
                      <img src={imgRelocation1} alt={imgRelocation1} />
                    </div>
                    <div className="card_galerie__struct">
                      <div className="text">
                        <div className="t1">Burj Khalifa</div>
                        <div className="t2">
                          Visit the tallest tour in the world
                        </div>
                      </div>

                      <div className="card_preview">
                        <img src={imgRelocation2} alt={imgRelocation1} />
                      </div>
                    </div>
                  </div>
                  <div className="card_galerie">
                    ...
                    <div className="card_galerie__struct">
                      ...
                      <div className="card_preview">
                        <img src={imgRelocation3} alt={imgRelocation1} />
                      </div>
                    </div>
                  </div>
                  <div className="card_galerie">
              ...
              <div className="check_form_list">
                <ul>
                  <li>
                    ...
                    <div className="text">Five days city tour.</div>
                  </li>
                  <li>
                    {" "}
                    <svg
                    ...
                    <div className="text">Available for 3 persons</div>
                  </li>
                  <li>
                    {" "}
                    <svg
                    ...
                    <div className="text">Visit 10 attractions in UAE</div>
                  </li>
                  <li>
                    {" "}
                    <svg
                ...
                <form action="" className="form">
                  <div className="form__struct">
                    <div className="form__struct__title">
                      ...
                      <div className="text">
                        <div className="t1">Create your package</div>
                        <div className="t2">Fill the form below</div>
                      </div>
                    </div>
                    ...
                    <div className="container_input">
                        ...
                        <div className="input_container">
                          <div className="input_container__struct">
                            <div className="after">
                              <div className="after__struct">
                                <span className="text">
                                  No.<span></span>Of<span></span>person
                                </span>
                                <span className="require_sign">
                                  <svg
                                    width={8}
                        ...
                        <div className="input_container">
                          <div className="input_container__struct">
                            <div className="after">
                              <div className="after__struct">
                                <span className="text">
                                  Passport<span></span>expiry<span></span>date
                                </span>
                                <span className="require_sign">
                                  <svg
                                    width={8}
                        ...
                        <div className="input_container">
                          <div className="input_container__struct">
                            <div className="after">
                              <div className="after__struct">
                                <span className="text">
                                  Select<span></span>multiple<span></span>places
                                </span>
                                <span className="require_sign">
                                  <svg
                                    width={8}
                            ...
                            <UaTown onchange={handleChangeInputTown}></UaTown>
                          </div>
                        </div>
                        <div
                      ...
                      <div className="hidden_input">
                        <input
                          onChange={handleChangeHiddenFileInput}
