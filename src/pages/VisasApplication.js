...
import imgUserCard from "../images/svg/user-card.svg";
import imgDocument from "../images/svg/documentimg.svg";
import imgIco from "../images/svg/imgico.svg";
...
const VisasApplication = () => {
  ...
  const handleClickPassport_btn = (e) => {
              ...
              <div className="check_form_list">
                <ul>
                  <li>
                    ...
                    <div className="text">Make sure your passport is at least 6 months valid</div>
                  </li>
                  <li>
                    {" "}
                    <svg
                    ...
                    <div className="text">Provide a valid phone number / WhatsApp number</div>
                  </li>
                  <li>
                    {" "}
                    <svg
                    ...
                    <div className="text">Upload a clear passport copy</div>
                  </li>
                  <li>
                    {" "}
                    <svg
                        ...
                        <div className="input_container">
                          <div className="input_container__struct">
                            <div className="after">
                              <div className="after__struct">
                                <span className="text">
                                Select<span></span>an<span></span>option
                                </span>
                      ...
                      <div className="input_group input_group_element">
                        ...
                        >
                          <div className="document_face__struct">
                            <img src={imgUserCard} alt={imgUserCard} />

                            <div className="document_face_bar"></div>
                            <div className="title">
                              Upload <br /> passport / ID
                            </div>
